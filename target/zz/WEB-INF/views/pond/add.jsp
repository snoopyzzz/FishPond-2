    ...
    <section id="main-content">
        <section class="wrapper">
            <table>
                ...
                <tr>
                    <td>养殖的鱼：</td>
                    <td><input name="breedFishId"></td>
                </tr>
                <tr>
                    <td>温度设备串口：</td>
                    <td><input name="comTemperature"></td>
                </tr>
                <tr>
                    <td>含氧量设备串口：</td>
                    <td><input name="comOxygen"></td>
                </tr>
                <tr>
                    <td>Ph值设备串口：</td>
                    <td><input name="comPh"></td>
                </tr>
                <tr>
                    <td>备注：</td>
    ...
    $(function(){
        $("#confirm").click(function(){
            ...
            var params = {"name":$("input[name='name']").val(),
                "breedFishId":$("input[name='breedFishId']").val(),
                "comTemperature":$("input[name='comTemperature']").val(),
                "comOxygen":$("input[name='comOxygen']").val(),
                "comPh":$("input[name='comPh']").val(),
